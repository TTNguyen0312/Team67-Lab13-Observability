...
### Nguyễn Thị Ngọc
- [TASKS_COMPLETED]: Demo lead, Performed incident injection testing, verified log compliance using `validate_logs.py`, write blueprint, write BONUS_COST_OPTIMIZATION, create demo plan, test/log/images(alerts rule, 6 dashboards, trace, trace waterfall) and compiled the final report.
